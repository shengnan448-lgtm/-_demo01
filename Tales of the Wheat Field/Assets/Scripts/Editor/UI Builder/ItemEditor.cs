...
public class ItemEditor : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        //拿到模版数据
        itemRowTemplate = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/Editor/UI Builder/ItemRow Template.uxml");

        //拿默认Icon图片
        defaultIcon = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Resources/Art/Items/Icons/icon_M.png");
